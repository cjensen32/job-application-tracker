...
| Add console-testing instruction                                  | Injected streams, exact rendering, full sessions, subprocess startup, EOF, and cleanup are needed to test the real boundary without global-state leaks.                                      | [Lesson 7](07-testing-console-applications.md), [test-writing conventions](../ch00-testing-standards/README.md)                                                                         |
| Add Java quality instruction                                     | Two-space formatting, import discipline, warnings, and Maven quality phases need an explanation before they become required gates.                                                           | [Lesson 8](08-java-quality-standards.md), [course standards](../ch00-course-standards/README.md)                                                                                        |
...
| Make Chapter 4 the dedicated test-writing and robustness chapter | Chapter 1 introduces testing mechanics, while a later chapter must teach maintainable test design, JUnit, Mockito, integration boundaries, and Spring slices in depth.                       | [Chapter 4 roadmap](../../LEARNING.md#chapter-4--test-writing-and-robustness-milestones-5-7), [test-writing conventions](../ch00-testing-standards/README.md)                           |
| Add course-wide architecture and quality conventions             | Maven layout, dependency direction, visibility, testing, and framework timing are repository decisions that later chapters need to reference consistently.                                   | [Course standards](../ch00-course-standards/README.md), [Maven standard layout](https://maven.apache.org/guides/introduction/introduction-to-the-standard-directory-layout)             |
...
| Keep `Main` as a composition root                                | Startup wiring should be independently reviewable; input, CRUD, and rendering belong in testable collaborators.                                                                              | [Main contract](CAPSTONE.md#main), [course dependency direction](../ch00-course-standards/README.md#dependency-direction)                                                               |
...
Include `pom.xml`, `config/checkstyle/checkstyle.xml`, `lessons/AUTHORING.md`, `../ch00-course-standards/README.md`, `../ch00-testing-standards/README.md`, and the applicable baseline and rationale from this record. These six groundwork files establish the historical starting point, Java 21 compiler warnings, Checkstyle validation, test-source enforcement, JaCoCo targets, lesson-writing rules, course conventions, and reusable test structure.
