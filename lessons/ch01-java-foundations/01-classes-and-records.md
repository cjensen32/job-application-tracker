...
This feels like ceremony at first. The payoff appears when libraries inspect declared types: an ORM can map the shape to storage, and a serializer can map it to JSON without making you describe the data twice.
