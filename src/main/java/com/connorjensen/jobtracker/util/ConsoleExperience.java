...
public class ConsoleExperience {
  ...
  public void applicationEntry(ApplicationService service) {
  ...
  public void listApplications(ApplicationService service) {
